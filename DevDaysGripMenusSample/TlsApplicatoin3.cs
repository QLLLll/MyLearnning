...
{
    class TlsApplication3 : IExtensionApplication
    {
        void IExtensionApplication.Initialize()
        {
            LArrow3.OverruleStart();
    ...
    class LArrow3
    {
        ...
        public LArrow3(Drawable d)
            : this((Line)d)
        { }
        public LArrow3(Entity ent)
            : this((Line)ent)
        { }
        //重定义生效
    ...
    //实现特殊的夹点
    class LArrowGripData3 : GripData
    {
        public LArrowGripData3(Point3d position)
        {
            GripPoint = position;
        }
        public void Move(LArrow3 la, Vector3d vec)
        {
            la.Position += vec;
            la.SaveExtendedData();
        }
    ...
    //夹点重定义
    public class LArrowGripOverrule3 : GripOverrule
    {
        public static LArrowGripOverrule3 TheOverrule = new LArrowGripOverrule3();
        public LArrowGripOverrule3()
        {
            SetXDataFilter(LArrow3.RegAppName);
        }
    ...
    //显示重定义
    public class LArrowDrawOverrule3 : DrawableOverrule
    {
        public static LArrowDrawOverrule3 TheOverrule = new LArrowDrawOverrule3();
        //设置重定义的过滤条件
        public LArrowDrawOverrule3()
        {
            SetXDataFilter(LArrow3.RegAppName);
        }
        //显示重载
        ...
        {
            LArrow3 la = new LArrow3(drawable);
            la.WorldDraw(wd);
