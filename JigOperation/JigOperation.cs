                           ...
                           if (i >= 1)
                            {
                                ...
                                dimAlign.DimLinePoint = cPoint3d + vec3d2 * 2.5;

                                dimAlign.DimensionText = null;

                                dimAlign.TextStyleId = DBHelper.GetSymbol(doc.Database.DimStyleTableId, "Standard");
